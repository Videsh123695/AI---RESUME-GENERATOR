    ...
    <main className="interview-page">
      <div className="interview-container">
        ...
        <aside className="interview-sidebar">
          <button onClick={() => setActiveSection("technical")}>
            Technical Questions
          </button>

          <button onClick={() => setActiveSection("behavioral")}>
            Behavioral Questions
          </button>

          <button onClick={() => setActiveSection("roadmap")}>Road Map</button>
        </aside>
        ...
        <section className="interview-content">
          ...
          {activeSection === "roadmap" && (
            <div>
              ...
              {report.preperationPlan.map((item, index) => (
                <div className="content-card" key={index}>
                  <h3>Day {item.day}</h3>
